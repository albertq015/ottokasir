...
public class AidlUtil {
    ...
    public ICallback generateCB(final ICallback printerCallback) {
     ...
     * @return list
     */
    public List<String> getPrinterInfo(ICallback printerCallback) {
        if (woyouService == null) {
            //Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return null;
        }
...
//            info.add(printerCallback.getResult());
     ...
     * 打印文字
     */
    public void printTextSunmi(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            //Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
...
//            woyouService.printTextWithFont(content, null, size, null);
    ...
    public void printTextAdvan(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            //Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
...
//            woyouService.printTextWithFont(content, null, size, null);
    ...
    public void printBitmap(Bitmap bitmap, int orientation) {
        if (woyouService == null) {
            Toast.makeText(context, "Service is disconnected", Toast.LENGTH_LONG).show();
            return;
        }
...
//            Toast.makeText(context, "Printer is Disconnected", Toast.LENGTH_LONG).show();
    ...
    public void setFontSize(float v) {
        try {
            woyouService.setFontSize(v, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
