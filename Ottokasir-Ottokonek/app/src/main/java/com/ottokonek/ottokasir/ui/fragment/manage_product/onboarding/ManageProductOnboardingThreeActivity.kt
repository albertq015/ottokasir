...
class ManageProductOnboardingThreeActivity : AppCompatActivity() {
    ...
    private fun contentOnboarding() {
        ...
        iv_onboarding.setImageResource(R.drawable.product_onboarding_en_3)
        title_onboarding.setText(R.string.title_onboarding_manage_three)
        description_onboarding.setText(R.string.description_onboarding_manage_three)
        steps_onboarding.setText(R.string.step_onboarding_manage_three)
        ...
        lanjut_onboarding.setOnClickListener {
            val intent = Intent(this, ManageProductOnboardingFourActivity::class.java)
            startActivity(intent)
        }
