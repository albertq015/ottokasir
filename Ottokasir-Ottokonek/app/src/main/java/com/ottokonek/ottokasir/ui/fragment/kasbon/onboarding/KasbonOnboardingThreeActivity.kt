...
class KasbonOnboardingThreeActivity : AppCompatActivity() {
    ...
    private fun contentOnboarding() {
        ...
        iv_onboarding.setImageResource(R.drawable.kasbon_onboarding_en_3)
        title_onboarding.setText(R.string.title_onboarding_kasbon_three)
        description_onboarding.setText(R.string.description_onboarding_kasbon_three)
        steps_onboarding.setText(R.string.step_onboarding_three)
        ...
        lanjut_onboarding.setOnClickListener {
            val intent = Intent(this, KasbonOnboardingFourActivity::class.java)
            startActivity(intent)
        }
