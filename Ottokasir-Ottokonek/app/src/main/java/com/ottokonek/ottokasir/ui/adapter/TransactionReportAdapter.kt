...
class TransactionReportAdapter(val context: Context) : RecyclerView.Adapter<TransactionReportAdapter.ViewHolder>() {

    private var listData = mutableListOf<TransactionReportResponse.DataBean.JenisProdukBean>()
    ...
    override fun onBindViewHolder(holder: ViewHolder, p1: Int) {
        ...
        holder.tvPrice.text = MoneyUtil.convertCurrencyPHP1(data.sub_amount)
    ...
    fun setData(data: MutableList<TransactionReportResponse.DataBean.JenisProdukBean>) {
        listData = data
