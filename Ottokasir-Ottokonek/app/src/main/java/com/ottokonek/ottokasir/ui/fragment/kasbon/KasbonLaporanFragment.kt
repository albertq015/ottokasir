...
import com.ottokonek.ottokasir.ui.activity.kasbon.KasbonTransactionReportActivity
...
import kotlinx.android.synthetic.main.fragment_kasbon_report.*
import java.util.*

class KasbonLaporanFragment : BaseLocalFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_kasbon_report, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        contentKasbonLaporan()
        actionKasbonLaporan()
    }


    private fun contentKasbonLaporan() {
    ...
    private fun actionKasbonLaporan() {
        ...
        btnTampilkan.setOnClickListener {
            if (DateUtil.comparingDate(startDate, endDate)) {
                val intent = Intent(requireActivity(), KasbonTransactionReportActivity::class.java)
                intent.putExtra(KasbonTransactionReportActivity.KEY_START_DATE, startDate)
                intent.putExtra(KasbonTransactionReportActivity.KEY_END_DATE, endDate)
                intent.putExtra(KasbonTransactionReportActivity.KEY_START_DATE_CONVERT, tvStartDate.text)
                intent.putExtra(KasbonTransactionReportActivity.KEY_END_DATE_CONVERT, tvEndDate.text)
