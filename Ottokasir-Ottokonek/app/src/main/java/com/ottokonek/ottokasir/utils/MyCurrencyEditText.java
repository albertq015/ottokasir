...
//                format = numberFormat.format(Double.parseDouble(text) / Math.pow(10, fractionDigit));
                format = numberFormat.format(Double.parseDouble(text));
            else
                format = numberFormat.format(Double.parseDouble(text)).replace(currencySymbol, "");
    ...
    public double getCurrencyDouble() throws ParseException {
        ...
        if (showSymbol())
            return Double.parseDouble(text.replace(currencySymbol, ""));
