...
class OrderItemKasbonQrPaymentAdapter(val context: Context, private val listItem: ArrayList<KasbonQrPaymentStatusResponseModel.DataBean.ItemsBean>?) : RecyclerView.Adapter<OrderItemKasbonQrPaymentAdapter.ViewHolder>() {
