...
class OrderItemKasbonCustomerAdapter(val context: Context, val listItem: List<PaymentCashBondResponseModel.DataBean.ItemsBean>?) : RecyclerView.Adapter<OrderItemKasbonCustomerAdapter.ViewHolder>() {
