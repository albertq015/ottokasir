...
class ManageProductOnboardingFiveActivity : AppCompatActivity() {
    ...
    private fun contentOnboarding() {
        ...
        iv_onboarding.setImageResource(R.drawable.product_onboarding_en_5)
        title_onboarding.setText(R.string.title_onboarding_manage_five)
        description_onboarding.setText(R.string.description_onboarding_manage_five)
        steps_onboarding.setText(R.string.step_onboarding_manage_five)
        ...
        lanjut_onboarding.setOnClickListener {
            val intent = Intent(this, ManageProductOnboardingSixActivity::class.java)
            startActivity(intent)
        }
