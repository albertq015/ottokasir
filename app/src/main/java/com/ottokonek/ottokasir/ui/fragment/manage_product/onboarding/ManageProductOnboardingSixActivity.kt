...
class ManageProductOnboardingSixActivity : AppCompatActivity() {
    ...
    private fun contentOnboarding() {
        ...
        iv_onboarding.setImageResource(R.drawable.product_onboarding_en_6)
        title_onboarding.setText(R.string.title_onboarding_manage_six)
        description_onboarding.setText(R.string.description_onboarding_manage_six)
        steps_onboarding.setText(R.string.step_onboarding_manage_six)
        ...
        lanjut_onboarding.setOnClickListener {
            val intent = Intent(this, ManageProductOnboardingSevenActivity::class.java)
            startActivity(intent)
        }
