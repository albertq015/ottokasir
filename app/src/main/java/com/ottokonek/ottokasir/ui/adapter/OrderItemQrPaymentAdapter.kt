...
class OrderItemQrPaymentAdapter(val context: Context, private val listItem: ArrayList<CheckStatusQrResponseModel.DataBean.ItemsBean>?) : RecyclerView.Adapter<OrderItemQrPaymentAdapter.ViewHolder>() {
