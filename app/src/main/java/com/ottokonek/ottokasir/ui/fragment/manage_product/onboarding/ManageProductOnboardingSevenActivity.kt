...
class ManageProductOnboardingSevenActivity : AppCompatActivity() {
    ...
    private fun contentOnboarding() {
        ...
        iv_onboarding.setImageResource(R.drawable.product_onboarding_en_7)
        title_onboarding.setText(R.string.title_onboarding_manage_seven)
        description_onboarding.setText(R.string.description_onboarding_manage_seven)
        steps_onboarding.setText(R.string.step_onboarding_manage_seven)
